...
while True:
    ...
    if not buttonA.value:
        text_area1.text = "snare"
        midi.send(NoteOn(SNARE, 120))  # G sharp 2nd octave
    ...
    if not buttonB.value:
        text_area1.text = "closed hihat"
        midi.send(NoteOn(CLOSEDHIHAT, 120))  # G sharp 2nd octave
    ...
    if not buttonX.value:
        text_area1.text = "kick"
        midi.send(NoteOn(ELECTRICKICK, 120))  # G sharp 2nd octave
    ...
    if not buttonY.value:
        text_area1.text = "open hihat"
        midi.send(NoteOn(OPENHIHAT, 120))  # G sharp 2nd octave
